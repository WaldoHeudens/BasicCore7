    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                BasicCore7User _user = _context.Users.FirstOrDefault(u => u.UserName == Input.UserName);
                ...
                if (_user.Blocked < DateTime.Now)
                {
                    ModelState.AddModelError(string.Empty, _localizer["Sorry, your account has been blocked."]);
                    return Page();
                }
