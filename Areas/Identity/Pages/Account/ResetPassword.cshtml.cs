...
namespace BasicCore7.Areas.Identity.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        private readonly IStringLocalizer<ResetPasswordModel> _localization;

        public ResetPasswordModel(UserManager<BasicCore7User> userManager, IStringLocalizer<ResetPasswordModel> localization)
        {
